...
def merge_two_type_depth(hifi_depths={}, nano_depths={}):
	"""
...
def compute_index(targets_length={}, prefix='GCI', dictionary='.', force=False, merged_depths_bed_list=[], type_list=[], flank_len=10):
	...
	input: targets_length generated by the function read_paf_bam() and filter_bam(),
	...
	output: an index file containing the expected N50, observed N50, genome continuity index
	"""
...
def GCI(hifi=[], nano=[], dictionary='.', prefix='GCI', threads=1, map_qual=30, iden_percent=0.9, ovlp_percent=0.9, clip_percent=0.1, flank_len=10, threshold=0, plot=False, force=False):
	...
	if nano == None:
		...
		merged_two_type_depths = merge_two_type_depth(hifi_depths, nano_depths)
