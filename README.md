![image](https://github.com/yeeus/GCI/assets/118142448/cc3f8d2c-2e79-40ef-b53c-0199a29e4637)# Genome Continuity Index
## About
...
**As for the version 1.5, we can only use one thread (see [To do](https://github.com/yeeus/GCI#to-do) for more details).**
...
| :--------------------------: | :----------: | :----------: | :----------: | :--------------------: | :--------------------: | :---: | :----------: | :-----: |
| HiFi (depth; GCI)            | ~58x; 41.8259  | xxxxxxxxxxxx | xxxxxxxxxxxx | ~83x; 7.9651         | ~83x; 14.9464 | ~51x; 7.9901 | ~90x; 30.7545  | ~39x; 49.8945 | 
| Nano (depth; GCI)            | ~134x; 87.0425 | xxxxxxxxxxxx | xxxxxxxxxxxx | ~257x; 34.9807 | ~257x; 35.4896 | ~103x; 30.5893 | ~480x; 99.9999 |  | 
| `depth of ONT-UL (>= 100Kb)` | ~39x           | ~20x   | ~20x  | ~34x |  ~34x | ~10x | ~3.8x |  | 
| HiFi + Nano                  | 87.0425        | 66.79  | 77.90 | 36.6257 | 41.6960 | 29.5146 | 99.9999 |  | 
...
- filter_bam.py
  - Usage
    ...
    - Example1
      ...
      >
      > Don't be confused! The results are generated by filtering both test.bam and test.paf files, where only the former are plotted here. If there is any contradiction with the final bed file, please check the paf file to figure out the conflict.
